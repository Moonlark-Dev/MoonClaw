...
# async def handle_state(event: GroupMessageEvent | PrivateMessageEvent, group_id: str = get_group_id(), user_id: str = get_user_id(), is_superuser: bool = is_user_superuser()):
#     # 检查用户是否为超级用户
#     if not is_superuser:
